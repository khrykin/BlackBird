...
void BlackFaceAudioProcessorEditor::setupControls() {
    ...
    addKnobToSection(oscillatorSection, oscillatorKnob, oscillatorTypeParameterID);
    addParameterAsKnobToSection(oscillatorSection, detuningParameterID, "Character");
