...
namespace DSPParametersConstants {
    constexpr auto oscillatorTypeParameterID = "oscillatorType";
    constexpr auto oscillatorTypeParameterName = "Oscillator Type";
    constexpr auto detuningParameterID = "detuning";
    constexpr auto detuningParameterName = "Detuning";
...
struct DSPParameters {
    std::atomic<float> *oscillatorType = nullptr;
...
private:
    static NormalisableRange<float> makeEnvelopeRange();
    static NormalisableRange<float> makeFrequencyRange();
    static NormalisableRange<float> makeGainRange();
};
